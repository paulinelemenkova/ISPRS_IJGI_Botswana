...
How the temperature extremes are distributed over Botswana (Fig. 2 and 3) is important to understand the distribution of PDSI values (Fig. 12). So, as can be seen in Fig. 2 (Tmin in Botswana in 2018), the minimal values over the country are recorded in the SE and S regions of the country in the proximity of Lobatse city and the Limpopo river valley where the values are lower and reach +16.5C and further to the east (region of South Africa). The maximal temperature (Tmax) in Botswana in 2018 is shown schematically in Fig. 3. An important aspect of the Tmax distribution over Botswana depicted in Fig. 3 is that the highest values of the Tmax are in the southern region of Kalahari (up to +38 C, bright red color in Fig. 3). This is partially caused by the typical hydrological and meteorological process of the evaporation due to the a lack of water as that all of the absorbed light goes into raising the surface temperature in the Kalahari Desert. The precipitation map (Fig. 4) exhibited some degree of spatial dependent distribution of rainfalls generally increasing to the north. However, the isolines demonstrate the rather wedge-shaped sharp decrease of values reaching maximum between the 21 and 22 E, that is, in the center of Kalahari Desert.  
...
The Okawanga Delta shows the transitional values between 80 and 111 mm (lilac and red colors in Fig. 4). the Ngotwane and Marico basins have values of 38 to 48 mm and the Makgadikgadi Pan has dominating values of 80 to 95 mm. Study of soil properties is important for environmental research (Lemenkov and Lemenkova, 2021a, 2021b). Variations in soil moisture (Fig. 5) show the least moisture in the Kalahari Desert (0–1 mm/m, i.e. extreme dry, yellow color in Fig. 5) with slight increase in the NW and selected central districts of Kalahari (1-2 mm/m, beige). 
...
Further gradual increase in soil moisture (2 to 5 mm/m, green colors) is notable in the NW region of the country, in the Okawanga Delta and on border with Namibia. Moderate variations (up to 10 mm/m) are also notable around the Sehithwa village (Fig. 5). The NW bias in the trend of the data distribution is notable in the norther of the country due to precipitation increase in the north together with the temperature decrease associated with climate effects in Botswana and clear influence of the Kalahari Desert in southern regions of the country. 
	
The potential evapotranspiration (PET) (Fig. 6) values are visualized continuously extracted for Botswana and ranging from minimum at 133 mm to a maximum at 250 mm, mean at 196.048 mm, standard deviation at 26.166 mm. The maximal is clearly visible in the lower region of Kalahari region (over 240 mm). 

Using GDAL inspection by 'gdalinfo', the actual evapotranspiration (AET) in Botswana (Fig. 7) was analyzed and the data variations is shown: Minimum at 13 mm, Maximum at 148 mm, Mean at 73.225 mm, StdDev at 28.295 mm. Here the minimal values correspond to the Kalahari Desert region in southern Botswana (values 0 to 50 mm). The gradients of isolines decrease (become less curved) in the northward direction to Okawanga Delta where the values reach up to 120 mm.

The curves of the fields of the downward surface shortwave radiation in Fig. 8 reflect the total amount of shortwave radiation, both direct and diffuse that reaches the Earth's surface over the area in Botswana. The overall increase in the values can be noticed as increasing towards the southern region of Kalahari where the values reach up to 326 Wm-2 (bright red colors in Fig. 8) from the lowest in the northern region with the minimal values of 234 Wm-2 (light beige colors in Fig. 8). The vapor pressure (Fig. 9) and vapor pressure deficit (Fig. 10) correlate in general trend increasing towards the southern regions of Kalahari Desert and reaching values of 2.56 atm from the minimal of 1.17 atm in the norther of the country for vapor pressure. 
...
As shown in Fig. 10 (Vapor Pressure Deficit, VPD of Botswana), there is a general trend for vapor pressure to be higher in the SW (Kalahari Desert with the highest values of 3.3, bright yellow color) and lower in the NE of Botswana (up to 1.4, purple colors in Fig. 10). The VPD shows the deficit between the moisture in the air and the amount of moisture the air can contain when saturated. 
	
The measured wind speed (Fig. 11) reaches the maximal values in the area of Jwaneng eastward of Kalahari. The inspection of data gives the following data range: minimum at 1.8 m/s, maximum at 3.4 m/s, mean at 2.587 m/s, and standard deviation of values at 0.352m/s (Fig. 11).

In general, the PDSI drought levels in Botswana in 2018 (Fig. 12) show stepwise variation of index with roughly seven areas: 1) -3.7 to -2.2. (extreme drought); 2) -2.2 to -0.8 (strong drought, southern Kalahari); 3) -0.8 to 0.7 (significant drought): central Kalahari; 4) 0.7 to 2.1 (moderate drought); 5) 2.1 to 3.5 (lesser drought); 6) 3.5 to 4.9 (low drought); 7) 4.9 to 6.4 (least drought), Fig. 12. 

The zero level is highlighted by the thick white isoline for the convenience of the classification (Fig. 12). One possibility to explain the PDSI values (Fig. 12) showing the minimal values (i.e., extreme drought with values -2.2 to -3.8) is that the minimal temperatures are recorded as the deepest around the Lobaste in the south of the country (Fig. 2) which also corresponds to the low precipitation level in this region, Fig. 4, 35 to 61 mm, green colors: region of Jwaneng, Gaborone, area southwards of Kalahari. 
...
In this region, the Downward Shortwave Surface Radiation (DSSR) is the highest with values exceeding 318 Wm-2 (compare Fig. 12 with Fig. 8). The next (lesser) level of drought severity with values of -0.8 to -2.2 (light plum color in Fig. 12) was then examined with map of the vapor pressure having consecutively decreasing values southwards of Kalahari (1.6 to 1.2) correlating to the 2nd level of drought of Botswana (-0.8 to -2.2). 
