...
The maximal temperature (Tmax) in Botswana in 2018 is shown schematically in Fig. 3. An important aspect of the Tmax distribution over Botswana depicted in Fig. 3 is that the highest values of the Tmax are in the southern region of Kalahari (up to +38 C, bright red color in Fig. 3). This is partially caused by the typical hydrological and meteorological process of the evaporation due to the a lack of water as that all of the absorbed light goes into raising the surface temperature in the Kalahari Desert.
	
The precipitation map in this data (Fig. 4) exhibited some degree of spatial dependent distribution of rainfalls generally increasing to the north. However, the isolines demonstrate the rather wedge-shaped sharp decrease of values reaching maximum between the 21 and 22 E, that is, in the center of Kalahari Desert. The Okawanga Delta shows the transitional values between 80 and 111 mm (lilac and red colors in Fig. 4). the Ngotwane and Marico basins have values of 38 to 48 mm and the Makgadikgadi Pan has dominating values of 80 to 95 mm. Study of soil properties is important for environmental research (Lemenkov and Lemenkova, 2021a, 2021b). Variations in soil moisture (Fig. 5) show the least moisture in the Kalahari Desert (0–1 mm/m, i.e. extreme dry, yellow color in Fig. 5) with slight increase in the NW and selected central districts of Kalahari (1-2 mm/m, beige).  	
