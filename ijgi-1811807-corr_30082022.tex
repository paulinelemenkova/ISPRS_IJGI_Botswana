...
\pubyear{2022}
\copyrightyear{2022}
\externaleditor{Academic Editor: Petar Jeremic
}
\datereceived{} 
...
\address[1]{%
 Laboratory of Image Synthesis and Analysis (LISA), École polytechnique de Bruxelles (Brussels Faculty of Engineering), Université Libre de Bruxelles (ULB),  Building L, Campus de Solbosch CP131/3, Avenue Franklin D. Roosevelt 50, B-1050 Brussels, Belgium; polina.lemenkova@ulb.be or pauline.lemenkova@gmail.com
Tel.:~+32-471860459}
...
\begin{figure}[H]
%\begin{center}
	\includegraphics[width=11.0 cm]{figures/fig_02.jpg} 
%\end{center}
...
\begin{figure}[H]
%\begin{center}
	\includegraphics[width=11.0 cm]{figures/fig_03.jpg} 
%\end{center}
...
In such regions, special measures and actions were introduced as state subsidies for drought relief management aimed at food and nutrition security~\cite{Belbase}. The assessment of social vulnerability to droughts in Botswana acts as a measure for the reduction of climate and environmental disaster risks~\cite{Dintwa}. Prevoius study ~\cite{Byakatonda2018a} recognised that hydrological droughts in Botswana may have several months of lag after the climatological droughts, which shows a complex and non-linear correlation between the hydrological, topographic and environmental factors associated with climate variability, which depend on precipitation pattern, Figure~\ref{fig:04}.  
   
\begin{figure}[H]
%\begin{center}
	\includegraphics[width=11.0 cm]{figures/fig_04.jpg} 
%\end{center}
...
\begin{figure}[H]
%\begin{center}
	\includegraphics[width=11.0 cm]{figures/fig_06.jpg} 
%\end{center}
...
\begin{figure}[H]
%\begin{center}
	\includegraphics[width=11.0 cm]{figures/fig_07.jpg} 
%\end{center}
...
\begin{figure}[H]
%\begin{center}
	\includegraphics[width=11.0 cm]{figures/fig_08.jpg} 
%\end{center}
...
\begin{figure}[H]
%\begin{center}
	\includegraphics[width=11.0 cm]{figures/fig_09.jpg} 
%\end{center}
...
\begin{figure}[H]
	\includegraphics[width=11.0 cm]{figures/fig_11.jpg} 
...
\begin{figure}[H]
%\begin{center}
	\includegraphics[width=11.0 cm]{figures/fig_12.jpg} 
%\end{center}
...
Chrisman, N.
\newblock {\em Exploring Geographic Information Systems}, 2nd ed.; John Wiley \& Sons: Hoboken, NJ, USA, 2001.
...
\newblock In Proceedings of the 2022 International Conference on Applied
  Artificial Intelligence and Computing (ICAAIC),  Kuala Lumpur, Malaysia, 9--10 December 2022; pp.~1565--1572.
...
\newblock In Proceedings of the 2018 IEEE 14th International Conference on
  e-Science (e-Science), Amsterdam, The Netherlands,  29 October--1 November 2018; pp. 362--363.
...
\newblock In Proceedings of the 2011 IEEE International Geoscience and Remote
  Sensing Symposium, Vancouver, BC, Canada, 24--29 July 2011; pp. 2218--2220.
...
\newblock In Proceedings of the 2010 IEEE International Geoscience and Remote
  Sensing Symposium, Honolulu, HI, USA, 25--30 July 2010; pp. 178--180.
...
\newblock {Participatory mapping of water collection by Sexaxa community in
  Okavango, Botswana}.
\newblock {\em Phys. Chem. Earth} {\bf 2020}, {\em 124},~102963.
...
\newblock {\em BMC Infect. Dis.} {\bf 2021}, {\em 21}, 1177.
...
\newblock {Research Paper no. 45, U.S. Department of Commerce Weather Bureau, 58; Washington DC
  pp. 1965.}
\newblock {Available online by NOAA: https://www.droughtmanagement.info/literature/USWB\_Meteorological\_Drought\_1965.pdf}
...
\newblock {Rift Valley fever vector diversity and impact of meteorological and
  ...
  Botswana}.
\newblock {\em Parasites Vectors} {\bf 2016}, {\em 9}, 434.
...
\newblock In Proceedings of the Oceans '04 MTS/IEEE Techno-Ocean '04 (IEEE Cat.
  No.04CH37600), Kobe, Japan, 9--12 November 2004;  Volume~2; pp. 1159--1162.
...
\newblock In Proceedings of the 2016 Fifth International Conference on
  Agro-Geoinformatics (Agro-Geoinformatics), Tianjin, China, 18--20 July 2016; pp. 1--4.
...
\newblock In Proceedings of the 2009 Third International Symposium on
  Intelligent Information Technology Application, Nanchang, China, 21--22 November 2009; Volume~2; pp. 129--133.
...
\newblock {\em ISPRS Int. J. Geo-Inf.} {\bf 2022}, {\em  11}, 257.
...
\newblock {\em ISPRS Int. J. Geo-Inf.} {\bf 2020}, {\em  9}, 631.
